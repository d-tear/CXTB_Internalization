...
Purpose: The pipeline implements an adaption and automation of a commonly used method called Corrected-Total-Cell-Fluorescence (CTCF), which is used to determinine the level of cellular fluorescence from fluorescence microscopy images. I created this pipeline to calculate fluorescent cholera toxin binding from super-resolution confocal z-stacks of individual cells. 
